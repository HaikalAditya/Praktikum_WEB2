...
<div id="pesan" class="row mb-3">
    <div class="col">
        ...
        if (!$result || mysqli_num_rows($result) == 0) {
            echo '<meta http-equiv="refresh" conten="0;url=?page=karyawan">';
        }
        ...
        <div class="card px-3 py-3">
            <form action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" placehholder="misal: HRD" value="<?php echo $row['nama'] ?>" required>
                </div>
                <div class="mb-3">
                    <label for="tanggal_mulai" class="form-label">Tanggal Mulai</label>
                    <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_mulai" placehholder="misal: HRD" value="<?php echo $row['tanggal_mulai'] ?>" required>
                </div>
                <div class="mb-3">
                    <label for="gaji_pokok" class="form-label">Gaji Pokok</label>
                    <input type="text" class="form-control" id="gaji_pokok" name="gaji_pokok" placehholder="misal: HRD" value="<?php echo $row['gaji_pokok'] ?>" required>
                </div>
